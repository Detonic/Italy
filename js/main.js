(function ($) {
    ...
    Landing.prototype.initLastPackNotice = function () {
        this.packNotify = new LastPackNotify({
            buyCount: 3,
            malePhrase: '{name}, г. {city}, купил {count} упаковки.<br>Осталось упаковок по акции: {newcount}',
            usersMin: 50, //Минимальное количество пользователей
            usersMax: 570, //Макс количество пользователей
            repeat: true, //Повторять вывод нотисов
            packCount: 60, //Кол-во на старте
            packCountSelector: '.lastpack'
        });
    };

    Landing.prototype.scrollTo = function (event) {
